<div class="p-6  sm:px-20 bg-green-300 border-b border-gray-200">
    <div>
    ...
    <div class="mt-6 text-gray-500">
        ...
        to helpyou build your application using a development environment that is simple, powerful, and enjoyable. We believe
