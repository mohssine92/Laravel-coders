<x-app-layout>
     ...
     <section class="bg-gray-700 py-12 mb-12">
        {{-- video 18  hasta min 12--}}
        {{-- es un gride de 2 columnas --}}
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="text-white">
               ...
               <p class="mb-2">
                ...
                Nivel: {{$course->level->name}}</p>
               <p class="mb-2">
                <i class="fa fa-"></i>
                Caregoria: {{$course->category->name}}</p>
               <p class="mb-2">
                <i class="fas fa-users"></i>
                Matriculados: {{ $course->students_count }}</p>
               <p>
                <i class="fas fa-star"></i>
                Calificacion {{ $course->rating }}</p>
            </div>
        </div>
    ...
    {{-- video 18 min : 12 ->   --}}
     <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            {{-- estos secciones occupan 2 col de 3  --}}
             ...
             <h1 class="font-fold text-3xl mb-2">Temario</h1>
              ...
              @foreach ($course->sections as $section )
                   ...
                   >
                        ...
                        >
                          <h1 class="font-bold text-lg text-gray-700">{{ $section->name }}</h1>
                        </header>
        ...
        <div class="order-1 lg:order-2">
           {{-- estos secciones occupan 1 col de 3 cols --}}
               ...
               <div class="card-body">
                   <div class="flex items-center">
                       ...
                       <div class="ml-4">
                          ...
                          <a class="text-blue-400 text-sm text-bold" href="">{{'@'.Str::slug($course->teacher->name,'')}}</a>
                       </div>
                   </div>
             ...
             @foreach ($similares as $similar )
               <article class="flex mb-6">
                  ...
                  <div class="ml-3">
                    ...
                    <p><i class="fas fa-star mr-2 text-yellow-400"></i>{{$similar->rating}}</p>
